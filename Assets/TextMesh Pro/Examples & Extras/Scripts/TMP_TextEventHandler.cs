...
namespace TMPro {
	...
	public class TMP_TextEventHandler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler {
		...
		[Serializable]
		public class LineInfoSelectionEvent : UnityEvent<int, TMP_LineInfo> { }
		...
		public LineInfoSelectionEvent onLineInfoSelection {
			get { return m_OnLineInfoSelection; }
			set { m_OnLineInfoSelection = value; }
		}
		[SerializeField]
		private LineInfoSelectionEvent m_OnLineInfoSelection = new LineInfoSelectionEvent();
		...
		void LateUpdate() {
			if (TMP_TextUtilities.IsIntersectingRectTransform(m_TextComponent.rectTransform, Input.mousePosition, m_Camera)) {
				...
				if (lineIndex != -1 && lineIndex != m_lastLineIndex) {
					...
					SendLineInfoSelection(lineIndex, lineInfo);
				}
				#endregion
		...
		private void SendLineInfoSelection(int lineIndex, TMP_LineInfo lineInfo) {
			if (onLineInfoSelection != null)
				onLineInfoSelection.Invoke(lineIndex, lineInfo);
		}
