...
namespace ForceDirectedGraph.DataStructure {
	...
	public class Link {
		...
		public Link(Guid firstNodeId, Guid secondNodeId)
			: this(firstNodeId, secondNodeId, 0.5f, Color.white, 3) {
		}
		...
		/// </summary>
		public Link(Guid firstNodeId, Guid secondNodeId, float width, Color color, int distance) {
		...
		public Link(Link link)
			: this(link.FirstNodeId, link.SecondNodeId, link.Width, link.Color, link.Distance) {
		}
